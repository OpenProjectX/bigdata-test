...
annotation class BigDataTest(
    ...
    val s3: Boolean = false,
    val fakeGcs: Boolean = false,
    val icebergRestCatalog: Boolean = false,
    val icebergRestCatalogTls: Boolean = false,
    val trino: Boolean = false,
    ...
    val icebergRestCatalogPort: Int = 0,
    val icebergRestCatalogTlsPort: Int = 0,
    val trinoPort: Int = 0,
