        ...
        if (properties.icebergRestCatalog.enabled) {
            builder.withIcebergRestCatalog(
                IcebergRestCatalogOptions(
                    ...
                    catalogName = properties.icebergRestCatalog.catalogName,
                    warehouse = properties.icebergRestCatalog.warehouse,
                    realm = properties.icebergRestCatalog.realm,
                    clientId = properties.icebergRestCatalog.clientId,
                    clientSecret = properties.icebergRestCatalog.clientSecret,
                    scope = properties.icebergRestCatalog.scope,
                    s3RoleArn = properties.icebergRestCatalog.s3RoleArn,
                    s3ExternalId = properties.icebergRestCatalog.s3ExternalId,
                    startupTimeoutSeconds = properties.icebergRestCatalog.startupTimeoutSeconds,
