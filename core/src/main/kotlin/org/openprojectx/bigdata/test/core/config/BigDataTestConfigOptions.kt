...
fun BigDataTestConfig.toTestKitOptions(): BigDataTestKitOptions {
    ...
    return BigDataTestKitOptions(
        ...
        icebergRestCatalog = IcebergRestCatalogOptions(
            ...
            catalogName = icebergRestCatalog.catalogName ?: IcebergRestCatalogOptions().catalogName,
            warehouse = icebergRestCatalog.warehouse ?: IcebergRestCatalogOptions().warehouse,
            realm = icebergRestCatalog.realm ?: IcebergRestCatalogOptions().realm,
            clientId = icebergRestCatalog.clientId ?: IcebergRestCatalogOptions().clientId,
            clientSecret = icebergRestCatalog.clientSecret ?: IcebergRestCatalogOptions().clientSecret,
            scope = icebergRestCatalog.scope ?: IcebergRestCatalogOptions().scope,
            s3RoleArn = icebergRestCatalog.s3RoleArn,
            s3ExternalId = icebergRestCatalog.s3ExternalId,
            startupTimeoutSeconds = icebergRestCatalog.startupTimeoutSeconds?.toLong()
                ?: IcebergRestCatalogOptions().startupTimeoutSeconds,
