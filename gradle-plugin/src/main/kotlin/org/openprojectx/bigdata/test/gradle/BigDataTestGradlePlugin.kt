...
class BigDataTestGradlePlugin : Plugin<Project> {
    override fun apply(project: Project) {
        ...
        val service = project.gradle.sharedServices.registerIfAbsent(
            ...
            spec.parameters.icebergRestCatalogCatalogName.set(extension.icebergRestCatalog.catalogName)
            spec.parameters.icebergRestCatalogWarehouse.set(extension.icebergRestCatalog.warehouse)
            spec.parameters.icebergRestCatalogRealm.set(extension.icebergRestCatalog.realm)
            spec.parameters.icebergRestCatalogClientId.set(extension.icebergRestCatalog.clientId)
            spec.parameters.icebergRestCatalogClientSecret.set(extension.icebergRestCatalog.clientSecret)
            spec.parameters.icebergRestCatalogScope.set(extension.icebergRestCatalog.scope)
            spec.parameters.icebergRestCatalogS3RoleArn.set(extension.icebergRestCatalog.s3RoleArn)
            spec.parameters.icebergRestCatalogS3ExternalId.set(extension.icebergRestCatalog.s3ExternalId)
            spec.parameters.icebergRestCatalogStartupTimeoutSeconds.set(extension.icebergRestCatalog.startupTimeoutSeconds)
    ...
    private fun Project.applyGradleTomlConfig(extension: BigDataTestGradleExtension) {
        ...
        extension.icebergRestCatalog.catalogName.tomlConvention(config.icebergRestCatalog.catalogName)
        extension.icebergRestCatalog.warehouse.tomlConvention(config.icebergRestCatalog.warehouse)
        extension.icebergRestCatalog.realm.tomlConvention(config.icebergRestCatalog.realm)
        extension.icebergRestCatalog.clientId.tomlConvention(config.icebergRestCatalog.clientId)
        extension.icebergRestCatalog.clientSecret.tomlConvention(config.icebergRestCatalog.clientSecret)
        extension.icebergRestCatalog.scope.tomlConvention(config.icebergRestCatalog.scope)
        extension.icebergRestCatalog.s3RoleArn.tomlConvention(config.icebergRestCatalog.s3RoleArn)
        extension.icebergRestCatalog.s3ExternalId.tomlConvention(config.icebergRestCatalog.s3ExternalId)
        extension.icebergRestCatalog.startupTimeoutSeconds.tomlConvention(config.icebergRestCatalog.startupTimeoutSeconds)
